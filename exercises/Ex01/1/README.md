...
![image](../1/assets/1.2.png)

**3**: As you want to onboard a new Trading Partner switch to the tab Partner Profiles.

![image](../1/assets/1.3.png)

**4**: Select Create->Trading Partner to create a new Trading Partner.

![image](../1/assets/1.4.png)

**5**: On the following screen, you need to maintain general data for the new trading partner as follows:
...
![image](../1/assets/1.5.png)

Please save the newly created Trading Partner.

![image](../1/assets/1.5.1.png)

**6**: Switch to the Contacts tab and select Create Contact

![image](../1/assets/1.6.png)

**7**: On the Contacts tab, you can add names and details of persons who are responsible at the Trading Partner side.

![image](../1/assets/1.7.png)


**8**: Navigate to the tab Identifier and create a Single Identifier.

![image](../1/assets/1.8.png)

**9**: Every Trading Partner needs at least two identifiers: one which is used in the exchange and a second one which
...
![image](../1/assets/1.9.png)

**10**: Maintain the second Single Identifier as follows:
Use Identification O-P123456 (with P123456 your user id), the same as Alias, 
select Type System SAP S/4HANA on Premise IDoc,
and Scheme N/A,
then save the new identifier.

![image](../1/assets/1.10.png)

**11**: In the security tab you need to add the partner ID which your trading partner will use to send the message. To make it simpler we use the same ID as in the step before.
O-P123456 (with P123456 your user id). Then save it.

![image](../1/assets/1.11.png)

**12**: As the AS2 Partner ID also need to be pushed to the Partner directory you need to activate it by clicking the activate toggle button. 

![image](../1/assets/1.12.png)

**13**: The Business Context is currently optional, but we need to create a system where the supported type system and communication details must be maintained.
Navigate to the tab System and select Create System.

![image](../1/assets/1.13.png)


**14**: Please add the following Details:
...
![image](../1/assets/1.14.png)

**15**: Select the beforehand created system to create the supported Type System. On tab Type System, select Create Type System.

![image](../1/assets/1.15.png)

**16**: Use UN/EDIFACT and Version D.02A S3, then save the new Type System.

![image](../1/assets/1.16.png)

**17**: Next, you need to maintain the communication details. Switch to tab Communication and select Create Communication.

![image](../1/assets/1.17.png)

**18**: As this Trading Partner will send an Order via AS2 you need to create an AS2 Sender.
Use in the Security Configuration Mode Profile and the AS2 Partner ID you’ve configured under the security tab.

![image](../1/assets/1.18.png)

**19**: As the backend will send an ORDRSP message back, you also need to create another communication as this should be received by the Trading Partner (which will forward it then to you via mail). To create that, you need first to find out the url of the simulated trading partner on your tenant.
...
![image](../1/assets/1.19.png)

**20**: Click on the tile with All.

![image](../1/assets/1.20.png)

**21**: Search for B2B-Partner-Simulator and copy the url with the copy button. This url will end with .com/as2/as2.
Do not use the url from the screenshot as your tenant might be a different one than the tenant from the screenshot.

![image](../1/assets/1.21.png)

**22**: Now jump back to TPM and there to your Trading Partner where you have to add another communication under the system tab.
...
![image](../1/assets/1.22.png)

**23**: Switch to the Tab Processing to enter to AS2 Ids, Subject and your mail address. Please use a mail address which works and where you can receive mails as the output will later be sent to that mail.
...
**2**: On the Agreements tab, create a new Agreement.

![image](../1/assets/2.2.png)
...
**5**: Please start with renaming the Agreement to Procure to Pay – P123456 (with P123456 your user id) and change the Description. Now you need to specify which Trading Partner Details you want to use. Please enter these details in the following order (with P123456 your user id):
...
**6**: Navigate to the tab B2B Scenarios and switch the Transaction to the edit mode.

![image](../1/assets/2.6.png)


**7**: There you see the transactions for the scenario. In our exercise, it is a two-way transaction initiated by the trading partner.

![image](../1/assets/2.7.png)


**8**: Please start on the right by clicking on the first Communication box within the flow and select AS2 for Communication.

![image](../1/assets/2.8.png)


**9**: Please click now on the Interchange box to define the Message Implementation Guideline. Select the drop-down list.
...
**10**: In the pop up select openSAP BTP4 - EDIFACT ORDERS and switch to the highest version. Then select Choose.

![image](../1/assets/2.10.png)


**11**: Last step for the definition of the Order is to select the Mapping box (which is also prepared by using the Integration Advisor). Select the drop-down list.

![image](../1/assets/2.11.png)


**12**: In the pop up select openSAP BTP4 - EDIFACT ORDERS to IDoc ORDERS and switch to the highest version. Then select Choose.

![image](../1/assets/2.12.png)


**13**: As the backend will also send an Order Response the necessary data for these needs also to be maintained. Select the Communication for the outgoing message to AS2.Receiver.

![image](../1/assets/2.13.png)


**14**: Please click now on the Interchange box to define the Message Implementation Guideline. Select the drop-down list.

![image](../1/assets/2.14.png)


**15**: In the pop up select openSAP BTP4 - EDIFACT ORDRSP and switch to the highest version. Then select Choose.

![image](../1/assets/2.15.png)


**16**: Last step for the definition of the Order Response is to select the Mapping box Select the drop-down list

![image](../1/assets/2.16.png)


**17**: In the pop up select openSAP BTP4 – Idoc ORDRSP to EDIFACT ORDRSP and switch to the highest version. Then select Choose.

![image](../1/assets/2.17.png)


**18**: Save the Agreement

![image](../1/assets/2.18.png)


**19**: Activate the agreement to write all necessary data into the Partner Directory Database.

![image](../1/assets/2.19.png)
...
**2**: If you haven’t done so before, create a new Package by clicking Create.
...
**4**: Navigate back to the list of existing packages by clicking Integrations and APIs.
...
**8**: In the popup, change the name to openSAP-Send-Purchase-Order_P123456 (with P123456 your User ID).
...
![image](../1/assets/3.10.png)


**11**: On the next dialog, select Navigate to open your package.
...
**13**: Please configure the integration flow with your UserID P123456. 
...
**14**: Please select the Confirmation message about transaction handling by selecting the checkmark. 
The runtime profile is preselected as Cloud Integration and select deploy! 

![image](../1/assets/3.14.png)
...
**5**: On this page, you see more details like Sender Name, Adapter Type, … and you can also jump to the technical monitoring if this is necessary, and you are also able to see the payload of the source and target message.
...
[Continue to Exercise 1A](../2/README.md)
